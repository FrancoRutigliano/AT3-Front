...
export const FaqForLaw = () => {
    ...
    return (
        <section >
            <h1 className="p-5 text-2xl md:text-3xl lg:text-5xl text-celeste text-center mt-32 mb-16 md:mb-20 md:w-2/3 md:mx-auto md:leading-snug">{t("faqForLaw.faqForLaw")}</h1>
