...
export const PeerToPeer = () => {
    ...
    return (
        <>
            <section className=' bg-[white]' ref={p2pRef} id='p2p'>
                ...
                <section className=" lg:mt-0 flex flex-col-reverse overflow-hidden  sm:grid sm:grid-cols-3 py-10">
                    <div className=" sm:col-span-2 py-5  md:p-12 lg:pl-7 lg:pr-2  lg:py-24 ">
                        <div className=" mx-auto px-10  md:p-0 md:w-full  text-center lg:text-left ltr:sm:text-left rtl:sm:text-right">
                            <h2 className="text-celeste mb-5 text-celeste text-2xl lg:text-6xl font-bold md:text-3xl py-2 break-words">
                                {t("como invertir.peer to peer")}

                            </h2>

                            <p className='text-dark-light md:pr-12 text-justify  text-xs ms:text-sm  md:mt-4 md:block  lg:text-base break-words'>
                               ...
                               <br />
                                ...
                                {t("como invertir.peer to peer p2.1.1")} <span className='text-celeste underline'>support@atomico3.io</span>  
