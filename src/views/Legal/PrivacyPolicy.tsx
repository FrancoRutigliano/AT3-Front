import { useTranslation } from "react-i18next";
    ...
    return (
            ...
            <div className="w-1/4 bg-gray-100 p-4 rounded-lg shadow-md mr-4 sticky top-20 h-screen overflow-y-auto">
                ...
                <li className=" p-5 border-l-4 border-celeste"><a href="#section1" className="text-black  " onClick={(e) => handleAnchorClick(e, 'section1')}> ¿Cuál es el contenido y alcance de esta Política de Privacidad?</a></li>
                <li className="p-5 border-l-4 border-celeste"><a href="#section2" className="text-black hover:underline" onClick={(e) => handleAnchorClick(e, 'section2')}>Alcance de su consentimiento</a></li>
                <li className="p-5 border-l-4 border-celeste"><a href="#section3"  onClick={(e) => handleAnchorClick(e, 'section3')} className="text-black hover:underline"> ¡Para tener en claro al momento de leer nuestra Política!</a></li>
                <li className="p-5 border-l-4 border-celeste"><a href="#section4" onClick={(e) => handleAnchorClick(e, 'section4')} className="text-black hover:underline"> ¿Qué información recolectamos y tratamos?</a></li>
                <li className="p-5 border-l-4 border-celeste"><a href="#section5" onClick={(e) => handleAnchorClick(e, 'section5')} className="text-black hover:underline"> ¿Con qué finalidades tratamos la información?</a></li>
                <li className="p-5 border-l-4 border-celeste"><a href="#section6" className="text-black hover:underline" onClick={(e) => handleAnchorClick(e, 'section6')}> ¿Con quien compartimos la información y cómo podemos tratar su Información Personal?</a></li>
                <li className="p-5 border-l-4 border-celeste"><a href="#section7" className="text-black hover:underline" onClick={(e) => handleAnchorClick(e, 'section7')}>¿Qué medidas de seguridad y confidencialidad de la información tomamos?</a></li>
                <li className="p-5 border-l-4 border-celeste"><a href="#section7" className="text-black hover:underline" onClick={(e) => handleAnchorClick(e, 'section8')}> ¿Cuáles son los derechos de los Usuarios sobre la información que proporcionan?</a></li>
                </ul>
            </div>
...
<section id="section5">
  ...
  <section className="mb-8"  id="section8">
    <h2 className="text-xl font-semibold mb-2">8. ¿Cuáles son los derechos de los Usuarios sobre la información que proporcionan?</h2>
    <p className="mb-4">
  ...
  <section className="mb-8"  id="section9">
    <h2 className="text-xl font-semibold mb-2">9. Modificación de la Política de Privacidad</h2>
    <p className="mb-4">
