    ...
    <section className=" text-white">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="text-center w-full">
          <h2 className="text-3xl font-bold sm:text-4xl">Noticias</h2>
        ...
        >
          ...
          />
            ...
            <img src={at3} alt="at3" className='text-left w-full h-[200px] object-cover rounded-lg' />
          ...
          >
            <img src={litio} alt="litio" className='text-left w-full  max-h-[200px] object-cover rounded-lg' />
