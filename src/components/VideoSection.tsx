...
export const VideoSection = () => {
  ...
  return (
    ...
    <section className=' flex flex-col justify-center items-center h-1/2 mt-20 mb-20 lg:mb-32  '>
      <h1 className='text-3xl px-5 text-center lg:text-5xl font-bold sm:text-4xl bg-custom-gradient bg-clip-text text-transparent  lg:mt-0 mb-20'>{t("videoSection.video section title")}</h1>
