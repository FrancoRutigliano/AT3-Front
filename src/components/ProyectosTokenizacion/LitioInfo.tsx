...
<section className="h-screen overflow-hidden bg-gray-50 sm:grid sm:grid-cols-2 sm:items-center">
  <div className="p-8 md:p-12 lg:px-16 lg:py-24">
    <div className="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
      ...
      <p className="hidden text-gray-500 md:mt-4 md:block text-justify">
      El litio se ha convertido en un elemento crucial en la era moderna, impulsando la revolución tecnológica y la transición hacia energías sostenibles. Con el crecimiento exponencial de la demanda de baterías para dispositivos electrónicos y vehículos eléctricos, entender el papel del litio es esencial para quienes desean mantenerse informados sobre las tendencias del mercado y las oportunidades de inversión.
      </p>
