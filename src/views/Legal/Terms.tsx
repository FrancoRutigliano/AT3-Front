...
export const Terms = () => {
    ...
    return (
        ...
        <section >
            <h1 className="text-celeste text-2xl lg:text-5xl text-center mt-32 mb-5">{t("termsAndConditions.terminos y condiciones")}</h1>
            <h5 className="text-gray-500 text-xs md:text-base w-2/3 mx-auto text-center mb-16 md:mb-20">{t("termsAndConditions.vigencia")}</h5>
