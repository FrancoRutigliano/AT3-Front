        ...
        <div className=" mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-5 lg:px-8">
          <div className=" sm:flex sm:items-center sm:justify-between border-b border-gray-100 pb-5">
            ...
            {/* <h1 className='text-center'>REDES SOCIALES</h1> */}
              ...
              <ul className=" py-4 text-sm flex justify-between items-center w-2/3 mx-auto ">
                <li className='flex items-center '>
                  <img src={facebook} alt="facebook" className='w-8 ml-4' />
                  <a href="https://www.facebook.com/profile.php?id=61565306192045&mibextid=ZbWKwL" className="text-white transition hover:text-blue-500 hover:underline ml-2" target='_blanck'> Facebook</a>
                </li>

                <li className='flex items-center' >
                  <img src={instagram} alt="insta" className='w-8 ml-4' />
                ...
                <li className='flex items-center' >
                  <img src={telegram} alt="telegram" className='w-8 ml-4' />
                ...
                <li className='flex items-center' >
                  <img src={twitter} alt="twitter" className='w-8 ml-4' />
                ...
                <li className='flex items-center' >
                  <img src={tiktok} alt="tiktok" className='w-8 ml-4' />
                ...
                <li className='flex items-center' >
                  <img src={linkedin} alt="linkedin" className='w-8 ml-4' />
                ...
                <li className='flex items-center' >
                  <img src={youtube} alt="youtube" className='w-8 ml-4 ' />
                  <a href="https://www.youtube.com/@atomico3oficial" className="text-white transition hover:text-blue-500 hover:underline ml-2" target='_blank'>
                  Youtube
                   </a>
                </li>
              </ul>
