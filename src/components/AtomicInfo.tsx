...
export const AtomicInfo = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 ">
    <div className="mx-auto w-full text-center  ">
      <h2 className="lg:text-6xl font-medium sm:text-4xl bg-custom-gradient bg-clip-text text-transparent  ">What is Atómico3?</h2>

      <p className="mt-4 text-gray-300 w-full mx-auto lg:text-lg">
